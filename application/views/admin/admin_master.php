...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>admin_<?php echo base_url(); ?>admin_css/style.css"> <!-- Generic style (Boilerplate) -->
    ...
    <body id="top">
        ...
        <div id="container">
            ...
            <div id="header-surround"><header id="header">
                    ...
                    <div id="user-info">
                        <p>
                            <span class="messages">Hello <a href="javascript:void(0);"> <?php echo $this->session->userdata('admin_name'); ?> </a> ( <a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/mail.png" alt="Messages"> 3 new messages</a> )</span>
                            <a href="javascript:void(0)" class="toolbox-action button">Settings</a> <a href="<?php base_url() ?>super_admin/logout" class="button red">Logout</a>
                        </p>
            ...
            <aside id="sidebar">
                ...
                <nav id="nav">
                    <ul class="menu collapsible shadow-bottom">
                        <li><a href="dashboard.html" class="current"><img src="img/icons/packs/fugue/16x16/dashboard.png">Dashboard<span class="badge">2</span></a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/add_category"><img src="img/icons/packs/fugue/16x16/application-form.png">Add Category</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/view_category"><img src="img/icons/packs/fugue/16x16/table.png">Manage Category</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/post_blog"><img src="img/icons/packs/fugue/16x16/application-form.png">Post Blog</a></li>
                        <li><a href="<?php echo base_url(); ?>home/manage_comments"><img src="img/icons/packs/fugue/16x16/chart.png"> Comments Manager </a></li>
                        <li>
                        ...
                        <li><a href="#"><img src="img/icons/packs/fugue/16x16/ui-tab-content.png">Tabs</a></li>
